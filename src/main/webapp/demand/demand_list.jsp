...
<div class="mainer pd30">
    <div class="container">
        <form class="search-form">
            ...
            <input type="hidden" name="orderBy" id="orderBy" value=""/>            <!-- 排序 -->
        </form>
        <!-- talents-top -->
                ...
                success: function (response) {
                    ...
                    if (response.totalCount > 0) {
                        ...
                        $(response.list).each(function () {
                            row += '<div class="row">'
                                    + '<dl><dt><a href="job_detail.html" class="tit">' + this.name + '</a><!--<span class="grade">综合评分：<span class="orange">85分</span></span></dt></dl>-->'
                                    + '<dl>'
