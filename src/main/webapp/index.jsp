...
<div class="mainer pd30">
    <div class="container">
        ...
        <div class="index-box">
            ...
            <div class="btn-start">
                <div class="inner">
                    <button type="button" class="ipt-button" onclick="window.location.href='demand/demand_list.jsp?menuNavigation=demandHall'">开始体验</button>
                </div>
            </div>
        </div>
        <!-- /index-box -->
...
<script>
    $(function () {
        $(".ipt-submit").click(function () {
            window.location.href = "/supplier/supplier_list.jsp?menuNavigation=talentPool&searchValue=" + $(".search-form input[name='searchValue']").val();
        });
    })
</script>
</html>